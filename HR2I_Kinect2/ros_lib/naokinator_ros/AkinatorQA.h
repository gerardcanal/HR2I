#ifndef _ROS_SERVICE_AkinatorQA_h
#define _ROS_SERVICE_AkinatorQA_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char AKINATORQA[] = "naokinator_ros/AkinatorQA";

  class AkinatorQARequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return AKINATORQA; };
    const char * getMD5(){ return "76b1588506eeb3580fd4917b824208b2"; };

  };

  class AkinatorQAResponse : public ros::Msg
  {
    public:
  ...
  class AkinatorQA {
    public:
    typedef AkinatorQARequest Request;
    typedef AkinatorQAResponse Response;
  };
