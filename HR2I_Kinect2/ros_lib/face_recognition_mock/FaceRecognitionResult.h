#ifndef _ROS_face_recognition_mock_FaceRecognitionResult_h
#define _ROS_face_recognition_mock_FaceRecognitionResult_h
...
namespace face_recognition_mock
{
  ...
  class FaceRecognitionResult : public ros::Msg
  {
    ...
    const char * getType(){ return "face_recognition_mock/FaceRecognitionResult"; };
