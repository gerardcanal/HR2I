#ifndef _ROS_face_recognition_mock_FaceRecognitionGoal_h
#define _ROS_face_recognition_mock_FaceRecognitionGoal_h
...
namespace face_recognition_mock
{
  ...
  class FaceRecognitionGoal : public ros::Msg
  {
    ...
    const char * getType(){ return "face_recognition_mock/FaceRecognitionGoal"; };
