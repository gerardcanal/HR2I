#ifndef _ROS_SERVICE_ResetHand_h
#define _ROS_SERVICE_ResetHand_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RESETHAND[] = "pr_msgs/ResetHand";

  class ResetHandRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RESETHAND; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class ResetHandResponse : public ros::Msg
  {
    public:
      bool ok;
      char * reason;
