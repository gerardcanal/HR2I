#ifndef _ROS_SERVICE_AddPrecomputedTrajectory_h
#define _ROS_SERVICE_AddPrecomputedTrajectory_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ADDPRECOMPUTEDTRAJECTORY[] = "pr_msgs/AddPrecomputedTrajectory";

  class AddPrecomputedTrajectoryRequest : public ros::Msg
  {
    public:
      pr_msgs::WAMPrecomputedBlendedTrajectory traj;
    ...
    const char * getType(){ return ADDPRECOMPUTEDTRAJECTORY; };
    const char * getMD5(){ return "75e7d5e1c8aabc62097ff8b39b0402be"; };

  };

  class AddPrecomputedTrajectoryResponse : public ros::Msg
  {
    public:
      bool ok;
      char * reason;
  ...
  class AddPrecomputedTrajectory {
    public:
