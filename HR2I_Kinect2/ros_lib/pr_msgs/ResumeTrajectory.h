#ifndef _ROS_SERVICE_ResumeTrajectory_h
#define _ROS_SERVICE_ResumeTrajectory_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RESUMETRAJECTORY[] = "pr_msgs/ResumeTrajectory";

  class ResumeTrajectoryRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RESUMETRAJECTORY; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class ResumeTrajectoryResponse : public ros::Msg
  {
    public:
      bool ok;
      char * reason;
