    ...
    def __init__(self):
        ...
        with self:
            ...
            StateMachine.add('WAIT_FOR_BLOBS', ReadObjectSegmentationTopic(), remapping={'received_clusters': 'segmented_clusters'},
                             transitions={'succeeded': 'DISAMBIGUATE'})
            ...
            StateMachine.add('RELEASE_NAO', ReleaseNAOFromWifiBotState(), remapping={'NAO_riding': 'out_NAO_riding'},
            ...
            StateMachine.add('GRASP_OBJECT', ExecuteBehavior(behavior_name='tomato_grasp'), transitions={'succeeded': 'succeeded', 'aborted': 'succeeded'})
