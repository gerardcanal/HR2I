...
#define MAX_PLANES_ITER 15 // Number of planes to be segmented... Those will be the biggest ones
...
public:
	...
	static pcl::PointIndices::Ptr segmentPlaneByDirection(pcl::PointCloud<pcl::PointXYZ>::Ptr pc, std::vector<float> direction, 
