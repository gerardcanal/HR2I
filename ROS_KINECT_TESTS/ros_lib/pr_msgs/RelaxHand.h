#ifndef _ROS_SERVICE_RelaxHand_h
#define _ROS_SERVICE_RelaxHand_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RELAXHAND[] = "pr_msgs/RelaxHand";

  class RelaxHandRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return RELAXHAND; };
    const char * getMD5(){ return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class RelaxHandResponse : public ros::Msg
  {
    public:
      bool ok;
      char * reason;
