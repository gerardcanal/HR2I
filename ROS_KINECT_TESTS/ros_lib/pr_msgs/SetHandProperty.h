#ifndef _ROS_SERVICE_SetHandProperty_h
#define _ROS_SERVICE_SetHandProperty_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char SETHANDPROPERTY[] = "pr_msgs/SetHandProperty";

  class SetHandPropertyRequest : public ros::Msg
  {
    public:
      int32_t nodeid;
      int32_t property;
    ...
    const char * getType(){ return SETHANDPROPERTY; };
    const char * getMD5(){ return "3f6e771cf7eca3cc142661b172d630ce"; };

  };

  class SetHandPropertyResponse : public ros::Msg
  {
    public:
      bool ok;
      char * reason;
