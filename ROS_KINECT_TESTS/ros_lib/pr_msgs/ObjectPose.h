#ifndef _ROS_pr_msgs_ObjectPose_h
#define _ROS_pr_msgs_ObjectPose_h
...
namespace pr_msgs
{
  ...
  class ObjectPose : public ros::Msg
  {
    public:
      ...
      pr_msgs::NameTypeValue st_properties;
      pr_msgs::NameTypeValue * properties;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(properties_lengthT > properties_length)
        this->properties = (pr_msgs::NameTypeValue*)realloc(this->properties, properties_lengthT * sizeof(pr_msgs::NameTypeValue));
      offset += 3;
      properties_length = properties_lengthT;
      for( uint8_t i = 0; i < properties_length; i++){
      offset += this->st_properties.deserialize(inbuffer + offset);
        memcpy( &(this->properties[i]), &(this->st_properties), sizeof(pr_msgs::NameTypeValue));
      }
    ...
    const char * getType(){ return "pr_msgs/ObjectPose"; };
