#ifndef _ROS_pr_msgs_WamSetupSeaCtrl_h
#define _ROS_pr_msgs_WamSetupSeaCtrl_h
...
namespace pr_msgs
{
  ...
  class WamSetupSeaCtrl : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "pr_msgs/WamSetupSeaCtrl"; };
    const char * getMD5(){ return "6714f77d58bb6129af5ebca9f942b31e"; };
