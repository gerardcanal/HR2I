#ifndef _ROS_naoqi_msgs_JointAnglesWithSpeedResult_h
#define _ROS_naoqi_msgs_JointAnglesWithSpeedResult_h
...
namespace naoqi_msgs
{
  ...
  class JointAnglesWithSpeedResult : public ros::Msg
  {
    ...
    const char * getType(){ return "naoqi_msgs/JointAnglesWithSpeedResult"; };
