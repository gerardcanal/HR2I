#ifndef _ROS_face_recognition_mock_FaceRecognitionFeedback_h
#define _ROS_face_recognition_mock_FaceRecognitionFeedback_h
...
namespace face_recognition_mock
{
  ...
  class FaceRecognitionFeedback : public ros::Msg
  {
    ...
    const char * getType(){ return "face_recognition_mock/FaceRecognitionFeedback"; };
