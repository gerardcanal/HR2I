#ifndef _ROS_common_ObjectPoseList_h
#define _ROS_common_ObjectPoseList_h
...
namespace common
{
  ...
  class ObjectPoseList : public ros::Msg
  {
    public:
      ...
      common::ObjectPose st_object_list;
      common::ObjectPose * object_list;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(object_list_lengthT > object_list_length)
        this->object_list = (common::ObjectPose*)realloc(this->object_list, object_list_lengthT * sizeof(common::ObjectPose));
      offset += 3;
      object_list_length = object_list_lengthT;
      for( uint8_t i = 0; i < object_list_length; i++){
      offset += this->st_object_list.deserialize(inbuffer + offset);
        memcpy( &(this->object_list[i]), &(this->st_object_list), sizeof(common::ObjectPose));
      }
    ...
    const char * getType(){ return "common/ObjectPoseList"; };
