#ifndef _ROS_face_recognition_FaceRecognitionFeedback_h
#define _ROS_face_recognition_FaceRecognitionFeedback_h
...
namespace face_recognition
{
  ...
  class FaceRecognitionFeedback : public ros::Msg
  {
    ...
    const char * getType(){ return "face_recognition/FaceRecognitionFeedback"; };
